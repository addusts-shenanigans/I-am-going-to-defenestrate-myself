...
/obj/machinery/shieldwall
	...
	light_outer_range = 3
	// pass_flags_self = parent_type::pass_flags_self & ~LETPASSCLICKS // monkestation edit: no you can't reach around the impenetrable shield (disabled because it pissed off fastdmm)
